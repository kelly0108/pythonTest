...
def getProvinceLLData(stDate, etDate, siteId, phpSessionId):
    try:
        url = "https://web.umeng.com/main.php?c=visitor&a=districtnet&ajax=module%3Dsummary%7Cmodule%3DprovinceList_orderBy%3Dpv_orderType%3D-1_currentPage%3D1_pageType%3D90&siteid=" + siteId + "&st=" + stDate + "&et=" + etDate + "&_=1539240115757"
        user_agent = "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/51.0.2704.103 Safari/537.36"
        headers = {"User-Agent": user_agent, "cookie": "PHPSESSID=" + phpSessionId}
...
if __name__ == "__main__":
    ...
    # 友盟APP统计的Sesssion
    ummo_ss = "--357e3aa3f3217acfb319a83b2e5db0ec1e72d1f5"
    umplus_uc_token = "1W6DBHVG9NQEMOIETCZFolw_1ba6411848e84d089b9cd1102c78bbfc"  # 周活月活时需要
    ...
    iphoneRelateId = "568c6743e0f55a9364001ec1"
    androidRelateId = "568c6646e0f55a20a5001931"
    iphoneAppId = "1ce1004639a55f0e3476c865"
    androidAppId = "1391005a02a55f0e6466c865"
    siteId = "4934593"
